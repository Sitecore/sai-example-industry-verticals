      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {articles.map((article, index) => {
            return (
              <div key={index} className="overflow-hidden rounded-lg border bg-background shadow-lg">
                <ContentSdkImage
                ...
                <div className="flex min-h-40 flex-col justify-between p-6">
                  ...
                  <p className="inline-flex items-center font-bold hover:underline">
                    <Link
                      href={article.url}
                      className="gap-1 inline-flex items-center font-bold text-sm text-accent-contrast transition-colors"
                    >
